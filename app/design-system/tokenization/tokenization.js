const tokenization = {
  ...
  groups: {
    ...
    components: [
      ...
      {
        name: "components/buttons/_not in use/primary-hover",
        hex: "#0a73eb",
        ref: "primary/700",
      },
      {
        name: "components/buttons/_not in use/primary-disabled",
        hex: "#88c0ff",
        ref: "primary/300",
      },
      {
        name: "components/buttons/_not in use/secondary-hover",
        hex: "#e27500",
        ref: "secondary/600",
      },
      {
        name: "components/buttons/_not in use/secondary-disabled",
        hex: "#ffc485",
        ref: "secondary/200",
      },
      {
        name: "components/buttons/_not in use/tertiary-hover",
        hex: "#9333ea",
        ref: "tertiary/600",
      },
      {
        name: "components/buttons/_not in use/tertiary-disabled",
        hex: "#e9d5ff",
        ref: "tertiary/200",
      },
      {
        name: "components/buttons/_not in use/success-hover",
        hex: "#16a34a",
        ref: "success/600",
      },
      {
        name: "components/buttons/_not in use/success-disabled",
        hex: "#86efac",
        ref: "success/300",
      },
      {
        name: "components/buttons/_not in use/warning-hover",
        hex: "#ca8a04",
        ref: "warnings/600",
      },
      {
        name: "components/buttons/_not in use/warning-disabled",
        hex: "#fef08a",
        ref: "warnings/200",
      },
      {
        name: "components/buttons/_not in use/error-hover",
        hex: "#dc2626",
        ref: "error/600",
      },
      {
        name: "components/buttons/_not in use/error-disabled",
        hex: "#fecaca",
        ref: "error/200",
      },
      {
        name: "components/buttons/_not in use/info-hover",
        hex: "#0284c7",
        ref: "info/600",
      },
      {
        name: "components/buttons/_not in use/info-disabled",
        hex: "#bae6fd",
        ref: "info/200",
      },
    ],
